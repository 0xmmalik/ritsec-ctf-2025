...
hint2 = int.from_bytes(b"These are some of my recent thoughts. You are required to agree!", "big")

print(factor(C3[0](x=hint2)))
...
# figure out the prime p first using J2_P4[0].subs({x:hint, y:y}) = 0 mod p
...
print(flag2)
print(f"\n\nRITSEC{{{str(flag2)[2:-1]}{str(flag1)[2:-1]}{str(flag3)[2:-1]}}}")
